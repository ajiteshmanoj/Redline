  ...
  return (
    <main className="relative min-h-screen">
      ...
      <div className="container py-8">
        ...
        {state.summary ? (
          <AdaptivePrintReport title={title} summary={state.summary} campaigns={state.campaigns} />
        ) : null}
  ...
  return (
    <div className="hidden print:block">
      ...
      <p className="mt-6 text-xs text-chalk-faint">
        Generated by Redline · adaptive multi-turn agent. Findings map to the OWASP LLM Top 10 and
        the MAS AI Risk Management Guidelines (Nov 2025).
      </p>
    </div>
  );
}
